...
******************************************************************************/
#ifndef MODELS_INCLUDE_UMEMORY_HPP_
#define MODELS_INCLUDE_UMEMORY_HPP_
...
class UMemory: public UntimedModel {
 ...
 public:
     ...
     * @param base (optional) The base address for the emulated memory space. 
     * Default value is zero.
     * @param wipe (optional) If set to true, erase memory cells after class 
...
#endif  // MODELS_INCLUDE_UMEMORY_HPP_
