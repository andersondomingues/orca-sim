...
enum DmaRoundRobin{
	CPU1 = 0,  //cpu is defined twice so it can receive more attention from the dma. 
	NI   = 1,
	CPU2 = 2,
	ETH  = 3
}

TDma::TDma(std::string name, 
		UMemory* mem, 
		THellfireProcessor* cpu, 
		TNetworkInterface* ni,  
		TEthernetInterface* eth,
	) : TimedModel(name){
