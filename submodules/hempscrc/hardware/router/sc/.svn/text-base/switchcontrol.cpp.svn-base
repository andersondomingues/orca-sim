...
//#ifdef MTI_SYSTEMC
//SC_MODULE_EXPORT(switch_control);
//#endif
...
void switch_control::controle_sequ(){
	//regNport localsender, localsender_ant, localaux, localfree, ack_h_local;
	...
	//else{
		...
		//localsender_ant=sender_ant.read();
		//localsender=sender.read();
		//ack_h_local=ack_h.read();
		//localfree=free.read();
